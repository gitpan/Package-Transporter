...
Package::Transporter - Export, Import, and AUTOLOAD meet under an OO interface
...
Another limitation is the incompatibility of modules exporting AUTOLOAD, which are indicated by a warning like 'Subroutine AUTOLOAD redefined at ...'. The effect is fatal, although the warning isn't. This module addresses the problem by replacing import with visit points and by adding a dispatch to AUTOLOAD.
