...
=item B<::After_END|Package::Transporter::Generator::After_END>

Copies missing subroutines from the __END__ section of the same package.


=item B<::Anonymous|Package::Transporter::Generator::Anonymous>

Minimal generator for wrapping of pre-defined anonymous subroutines.


=item B<::Argument_in_Name|Package::Transporter::Generator::Argument_in_Name>

Hardwire one argument into the name of the subroutine. 


=item B<::Automatic_Require|Package::Transporter::Generator::Automatic_Require>

Attempt an 'require MODULE' for a missing MODULE::subroutine.


=item B<::Export|Package::Transporter::Generator::Export>

On-demand (proxy) export


=item B<::Fatal|Package::Transporter::Generator::Fatal>

Partial bridge to Fatal.pm


=item B<::Get_Set_Methods|Package::Transporter::Generator::Get_Set_Methods>

Automatically created accessors and mutators


=item B<::Hello_Anything|Package::Transporter::Generator::Hello_Anything>

Full example from synopsis.


=item B<::Homonymous_Packages|Package::Transporter::Generator::Homonymous_Packages>

Subroutines from the same package in a different file


=item B<::Homonymous_Tie|Package::Transporter::Generator::Homonymous_Tie>

Subroutines from a DB file of the same name as the package


=item B<::Interactive|Package::Transporter::Generator::Interactive>

AUTOLOAD interactive (write missing subroutines as the running program encounters them)


=item B<::Pipe|Package::Transporter::Generator::Pipe>

AUTOLOAD via a Unix pipe


=item B<::Require_Customized|Package::Transporter::Generator::Require_Customized>

Include customized file content


=item B<::SQL_Table|Package::Transporter::Generator::SQL_Table>

Store your subroutines in a database


=item B<::Shell|Package::Transporter::Generator::Shell>

Bridge to Shell.pm


=item B<::Simple_Stubs|Package::Transporter::Generator::Simple_Stubs>

Simple subroutines stubs


=item B<::Suggested_Use|Package::Transporter::Generator::Suggested_Use>
