...
=item B<Symbol Mix> - SYM_EXCLUSIVE(*) / SYM_COMPLEMENT

Whether the symbols associated are mixed exclusively (existing symbols are an error) or whether they complement existing symbols.
