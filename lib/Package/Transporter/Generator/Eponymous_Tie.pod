...
When running under -c ('syntax check only'), the module will load all definitions from the eponymous db file. This reduces the chance of unpleasant surprises.
