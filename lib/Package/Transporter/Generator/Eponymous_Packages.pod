...
Package::Transporter::Generator::Eponymous_Packages - subroutines from the same package in a different file
...
Set the search path via @INC or give directory names when setting up the generator manually. Example:
	...
	my $generator = $_[0]->create_generator('::Eponymous_Packages', 
