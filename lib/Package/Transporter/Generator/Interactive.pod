...
Package::Transporter::Generator::Interactive - write missing subroutines as the running program encounters them
...
Chances are that you can recover from an otherwise fatal situation, but any kind of recovery has to be practiced.
