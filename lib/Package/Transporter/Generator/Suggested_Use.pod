...
Package::Transporter::Generator::Suggested_Use - Issue the right 'use MODULE' to get the missing subroutine
...
Configure the generator by creating it manually and passing a manually created object of the class Package::Transporter::Generator::Suggested_Use::Suggestions to it.
